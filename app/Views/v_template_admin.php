...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('Admin')?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Skanic Perpus</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?= $user['nama_user']?>
          <?php
          if ($user['level']== 0 ) {
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  <?= $menu == 'masterbuku' ? 'menu-open':'' ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('Penerbit')?>" class="nav-link <?= $submenu == 'penerbit' ? 'active':'' ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penerbit</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?= base_url('Penulis')?>" class="nav-link <?= $submenu == 'penulis' ? 'active':'' ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penulis</p>
                </a>
              </li>
